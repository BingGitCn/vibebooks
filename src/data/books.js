...
export const booksData = [
  ...
  // VOL.004 - 莫斯科绅士
  {
    ...
    moodScore: 8.8,
    worldComponent: 'MoscowGentlemanWorld' // 有专属沉浸世界
  },
  // VOL.005 - 夜晚的潜水艇
  {
    id: 5,
  ...
  // VOL.013 - 挪威的森林
  {
    ...
    vol: '013',
    title: '挪威的森林',
    subtitle: 'Norwegian Wood',
    author: '村上春树',
    category: 'FICTION',
    accentColor: '#2d5a4a',
    geometric: 'forest',
    quote: '死并非生的对立面，而作为生的一部分永存',
    typography: 'melancholic',
    layout: 'layered',
  ...
  // VOL.020 - 小岛经济学
  {
    ...
    vol: '020',
    title: '小岛经济学',
    subtitle: 'Fish, Credit, and Crushing Debt',
    author: '彼得·希夫',
    category: 'ECONOMICS',
    accentColor: '#3a7c6a',
    geometric: 'island',
  ...
  // VOL.025 - 面纱
  {
    ...
    vol: '025',
    title: '面纱',
    subtitle: 'The Painted Veil',
    author: '毛姆',
    category: 'FICTION',
    accentColor: '#e4d4c4',
    geometric: 'veil',
    quote: '爱的代价是痛苦',
    typography: 'revealing',
    layout: 'unfolding',
    layoutVariant: 'title-bottom',
    tags: ['爱情', '成长', '中国'],
  ...
  // VOL.031 - 马可瓦尔多
  {
    ...
    category: 'FICTION',
    accentColor: '#6a8a5a',
    geometric: 'urban-nature',
    quote: '在钢筋森林中寻找诗意',
    typography: 'whimsical',
  ...
  // VOL.032 - 基督山伯爵
  {
    ...
    vol: '032',
    title: '基督山伯爵',
    subtitle: 'Le Comte de Monte-Cristo',
    author: '大仲马',
    category: 'ADVENTURE',
    accentColor: '#2a3a5a',
    geometric: 'revenge',
  ...
  // VOL.035 - 解忧杂货店
  {
    ...
    category: 'FICTION',
    accentColor: '#f4b44a',
    geometric: 'time-connect',
    quote: '地图是一张白纸',
    typography: 'heartwarming',
